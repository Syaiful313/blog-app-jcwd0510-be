...
router.post("/", jwt_1.verifyToken, (0, multer_1.uplouder)().fields([{ name: "thumbnail", maxCount: 1 }]), fileFilter_1.fileFilter, blog_validator_1.validateCreateBlog, blog_controller_1.createBlogController);
